    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-6 bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-6">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-xl font-extrabold text-emerald-700">₹{Number(amount).toLocaleString('en-IN')}</span>
              </div>
              <input
                type="range"
                min="10000"
            ...
            <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-2 text-xs text-slate-600">
              ...
              <p>Annual Interest Rate locked at <strong>{applicableRate}% p.a.</strong> based on your credit score tier.</p>
            ...
            <button
              ...
              className="w-full py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold rounded-xl shadow-lg flex items-center justify-center space-x-2 text-base transition-all mt-4"
            >
              {loading ? (
          ...
          {/* Right Live Loan Calculation Card (6 cols) */}
